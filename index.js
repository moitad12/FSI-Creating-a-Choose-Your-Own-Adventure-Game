...
if(firstAnswer === 'left') {
    let secondAnswer = window.prompt('You come across a stray cat. It scampers off down a small hole, just large enough for you to crawl through. Do you follow it, or continue on you path?')
    if(secondAnswer === 'follow') {
        ...
        if(thirdAnswer === 'ladder'){
            let fourthAnswer = window.alert('After ascending a few feet up the ladder, one of its rungs snaps, and you comedically fall through each of the rungs below. Sweepish, you return home.')
    ...
    if(secondAnswer === 'Past the dragon'){
        ...
        if(thirdAnswer === 'Stay'){
            ...
            let fourthAnswer = window.alert('Quickly, you run back to the caves entrance. Sheepish, you return home.')
        }
        ...
        if(thirdAnswer === 'Draw it'){
            ...
            let fourthAnswer = window.alert('You pick the flower and bring it home, and all marvelat its brilliance. However, over time it fades and eventually crumbles to dust.')
        }
    }
}
